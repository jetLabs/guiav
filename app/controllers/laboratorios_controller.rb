class LaboratoriosController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @laboratorio.save
        ...
        format.json { render action: 'show', status: :created, location: @laboratorio }
      else
  ...
  private
    ...
    def laboratorio_params
      params.require(:laboratorio).permit(:nombre, :razon_social, :direccion, :departamento, :telefono, :web)
    end
end
